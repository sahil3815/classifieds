					...
					if ( rtcl()->has_pro() ) {
						if ( ! empty( $instance['rtcl_show_compare'] ) ) :
							...
							<div class="rtcl-el-button">
								...
								?>
								<a class="rtcl-compare <?php echo esc_attr( $selected_class ); ?>" href="#" title="<?php esc_attr_e( 'Compare', 'classified-listing-toolkits' ); ?>" data-listing_id="<?php echo absint( $_id ); ?>">
