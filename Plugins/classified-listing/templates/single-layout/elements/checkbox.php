...
?>
<div class="rtcl-sl-element rtcl-checkbox-field <?php echo esc_attr( $fieldObj['direction'] ?? '' ); ?>  label-<?php echo esc_attr($labelPlacement)?> <?php echo esc_attr($vertical_cols)?>">
	<?php
